 ...
 * @author ADMON
 */
public class FormAddManHinh extends javax.swing.JFrame {

    /**
     * Creates new form FormAddManHinh
     */ 
    DefaultTableModel tblModel;
    SanPhamChiTietDao spctdao = new SanPhamChiTietDao();
    public FormAddManHinh() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormAddManHinh.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormAddManHinh().setVisible(true);
            }
        });
    }
    ...
    private void fillToTable() {
        ...
        for (ManHinh mh : spctdao.getAllMH()) {
            Object[]o = {
              mh.getMaHinhID(),
                mh.getLoaiManHinh()
            };
