 ...
 * @author ADMON
 */
public class FormAddCPU extends javax.swing.JFrame {

    /**
     * Creates new form FormAddCPU
     */
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String txtCPU = JOptionPane.showInputDialog("Mời nhập vào giá trị màn hình:");
        spctdao.AddManHinh(txtCPU);
        fillToTable();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormAddCPU.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormAddCPU().setVisible(true);
            }
        });
    }
